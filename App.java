...
public class App {
    ...
    private void initializeGUI() {
        outerFrame.setTitle("Smart Home App");
    ...
    private class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Add Device")) {
                        ...
                        if (selectedDevice != null) {
                            ...
                            if (deviceName != null) {
                                ...
                                if (selectedDevice.equals("LightBulb")) {
                                    ...
                                    newDevice = new Thermostat(deviceName, 22.0);
                                } else if (selectedDevice.equals("Camera")) {
                                    newDevice = new Camera(deviceName, "1080p", "MP4");
                                }
                ...
                } else if (selectedDevice instanceof Camera) {
                    Camera camera = (Camera) selectedDevice;
